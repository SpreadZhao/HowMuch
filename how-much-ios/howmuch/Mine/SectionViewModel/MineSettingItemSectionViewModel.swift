//
//  MineSettingItemViewModel.swift
//  howmuch
//
...
final class MineSettingItemSectionViewModel: ListDiffable {
    ...
    func isEqual(toDiffableObject object: (any ListDiffable)?) -> Bool {
        guard let otherViewModel = object as? MineSettingItemSectionViewModel else {
            return false
        }
